...
<a 
  ...
  className="flex-1 inline-block bg-gradient-to-r from-blue-100 to-blue-200 bg-white border border-gray-200 text-gray-600 font-medium text-xs px-2 py-1 rounded-full transition-transform duration-200 hover:scale-105 whitespace-nowrap truncate"
  style={{ fontFamily: "Roboto, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", maxWidth: '150px' }}
